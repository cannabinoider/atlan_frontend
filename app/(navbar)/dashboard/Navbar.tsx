...
export default function Navbar() {
  ...
  const options = [
    { icon: searchIcon, route: '/dashboard', value: 'Dashboard', action: () => router.push('/dashboard') },
    // { icon: cabIcon, route: 'booking', value: 'Booking', action: () => router.push('/booking') },
    // { icon: <PaymentIcon />, route: 'payment', value: 'Payment', action: () => router.push('/payment') },
    // { icon: <TrackChangesIcon />, route: 'status', value: 'Status', action: () => router.push('/status') },
    { icon: cabIcon, route: 'status', value: 'My Status', action: () => router.push('/status') },
    { icon: <LogoutIcon />, route: '/', value: 'Logout', action: handleLogoutClick } 
  ];
  ...
  return (
    <>
      ...
      <Drawer anchor="left" open={open} onClose={toggleDrawer(false)}>
        <div className="p-2">
          <div className="flex items-start my-3 font-medium text-xl">
